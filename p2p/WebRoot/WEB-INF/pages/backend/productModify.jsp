		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<form class="form-horizontal" role="form" method="post"
					action="${pageContext.request.contextPath }/product/productModify.action">

					<div class="form-group">
						<label for="productID" class="col-lg-2 control-label">产品编号</label>
						<div class="col-lg-10">
							<input type="text" class="form-control" id="productID" name="product.productId" value="${product.productId }" readonly="readonly">
						</div>
					</div>
					...
					<div class="form-group">
		                ...
		                <div class="col-lg-10">
		                  <input type="text" class="form-control" id="productName" name="product.productName" value="${product.productName }" placeholder="产品名称">
		                </div>
	                </div>
					...
					<div class="form-group">
						...
						<div class="col-lg-10">
							<div class="input-group col-lg-3" style="float: left;">
								<input type="text" class="form-control" name="product.primeLendingRateFrom" value="${product.primeLendingRateFrom}" placeholder="最低利率,不填默认为0">
								<span class="input-group-addon">%</span>
							</div>
							<div class="input-group col-lg-4">
								<input type="text" class="form-control" name="product.primeLendingRateTo" value="${product.primeLendingRateTo}" placeholder="最高利率,可不填,不填认为利率为固定值">
								<span class="input-group-addon">%</span>
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-lg-10">
							<select data-toggle="select" class="form-control select select-default" name="product.company.companyId">
					...
					<div class="form-group">
						...
						<div class="col-lg-10">
							<div class="input-group col-lg-3" style="float: left;">
								<input type="text" class="form-control" name="product.financingAmountFrom" value="${product.financingAmountFrom}" placeholder="最低贷款规模,不填默认为0">
								<span class="input-group-addon">万</span>
							</div>
							<div class="input-group col-lg-5">
								<input type="text" class="form-control" name="product.financingAmountTo" value="${product.financingAmountTo}" placeholder="最高贷款规模,可不填,不填认为贷款规模为固定值">
								<span class="input-group-addon">万</span>
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-lg-10">
							<select data-toggle="select" class="form-control select select-default" name="product.productType.productTypeId">
					...
					<div class="form-group">
						...
						<div class="col-lg-10">
							<select data-toggle="select" class="form-control select select-default" name="product.lendingPeriod.lendingPeriodId">
								<c:forEach items="${lendingPeriods }" var="lendingPeriod">
									<option value="${lendingPeriod.lendingPeriodId }">${lendingPeriod.period }个月</option>
								</c:forEach>
							</select>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-lg-10">
							<input type="text" class="form-control" id="linkman" name="product.linkMan" value="${product.linkMan}" placeholder="联系人">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-lg-10">
							<input type="text" class="form-control" id="bank" name="product.ownedBank" value="${product.ownedBank}" placeholder="联系银行">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-lg-10">
							...
							<input type="hidden" name="company.companyDetail" id="contentInput" /><br/>
						</div>
					</div>
					<div class="form-group">
						<div class="col-lg-offset-2 col-lg-10">
							<button type="submit" class="btn btn-lg btn-info" style="padding: 15px 60px; border-radius: 0px;" onclick="inputSubmit();">
								修改
							</button>
						</div>
					</div>
