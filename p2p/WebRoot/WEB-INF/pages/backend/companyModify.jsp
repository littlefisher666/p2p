...
<html>
	<head>
		...
		<script type="text/javascript">
			var content = $("#content").wysiwyg('getContent').html();
	...
	<body style="padding: 5px 10px">
		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<form class="form-horizontal" role="form" method="post" action="${pageContext.request.contextPath }/company/companyModify.action">
					<div class="form-group">
						<label for="companyId" class="col-lg-2 control-label">企业编号</label>
						<div class="col-lg-10">
							<input type="text" class="form-control" id="companyId" name="company.companyId" value="${company.companyId }" readonly="readonly">
						</div>
					</div>
					<div class="form-group">
						<label for="companyName" class="col-lg-2 control-label">企业名称</label>
						<div class="col-lg-10">
							<input type="text" class="form-control" id="companyName" name="company.companyName" placeholder="产品名称">
						</div>
					</div>
