	...
	<body style="padding: 5px 10px">
		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<form class="form-horizontal" role="form" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath }/news/newsModify.action">
					<div class="form-group">
						<label for="newsId" class="col-lg-2 control-label">新闻编号</label>
						<div class="col-lg-10">
							<input type="text" class="form-control" id="newsId" value="${news.newsId }" name="news.newsId" readonly="readonly" />
						</div>
					</div>
					<div class="form-group">
						<label for="newsName" class="col-lg-2 control-label">新闻标题</label>
						<div class="col-lg-10">
							<input type="text" class="form-control" id="newsName" name="news.newsTitle" value="${news.newsTitle}">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-lg-10">
							...
							<input type="hidden" name="news.content" id="contentInput" />
							<br />
						</div>
					</div>
